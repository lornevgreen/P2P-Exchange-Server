...
User can update email and phone number only , condition will follow by coinsn generated by raida server.
System will automaticaly check if user exist or not, then perform create or update user. coinsn field will use as indentifier.
